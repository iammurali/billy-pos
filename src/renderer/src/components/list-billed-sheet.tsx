...
import { ReceiptIndianRupeeIcon, Recycle, Trash2 } from 'lucide-react'

dayjs.extend(utc)

export function BilledBills({
  onClickBills,
  billedBills,
  restoreBill
}: {
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button onClick={() => onClickBills()} className="mr-2" variant={'outline'} size="sm">
      ...
      <SheetContent className="p-0">
        <SheetHeader className="p-4 border-b">
          <SheetTitle className="flex flex-row items-center">
            <ReceiptIndianRupeeIcon className="mr-2" /> Invoiced bills
          </SheetTitle>
