...
export function BilledBills({ draftBills, restoreDraft, deleteDraft, onClickDrafts }: { draftBills?: DraftBill[], restoreDraft: (draftBill: DraftBill) => void, deleteDraft: (draftBill: DraftBill) => void, onClickDrafts: () => void }) {
  return (
    <Sheet>
